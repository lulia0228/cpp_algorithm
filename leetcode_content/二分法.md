...
[力扣](https://leetcode-cn.com/problems/ugly-number-iii/) / [Leetcode](https://leetcode.com/problems/ugly-number-iii/) / [Python3](../python-algorithm/algo_04_erfen/L658-m.py) 
```
...
[力扣](https://leetcode-cn.com/problems/search-insert-position/) / [Leetcode](https://leetcode.com/problems/search-insert-position/) / [Python3](../python-algorithm/ds_9_bit_operation/L540-m.py)
```
