...
* [递归-整数](#递归返回整数)
    ...
    * [8. 相同节点值的最大路径长度](#8-相同节点值的最大路径长度)
    * [9. 统计左叶子节点的和](#9-统计左叶子节点的和)
...
* [二叉搜索树特性](#二叉搜索树特性)
    ...
    * [11. 把二叉搜索树转换为累加树](#11-把二叉搜索树转换为累加树)
...
* [树的遍历](#树的遍历)
    ...
    * [3. 之字形遍历](#3-之字形遍历)
    * [4. 二叉树的右视图](#4-二叉树的右视图)
    * [5. 填充每个节点的下一个右侧节点指针](#5-填充每个节点的下一个右侧节点指针)  
    * [6. 得到左下角的节点](#6-得到左下角的节点)
    * [7. 二叉树中所有距离为K的结点](#7-二叉树中所有距离为K的结点)
    * [8. 二叉树的下一个中序遍历节点](#8-二叉树的下一个中序遍历节点)
    * [9. 层数最深叶子节点的和](#9-层数最深叶子节点的和)
    * [10. 后继者](#10-后继者)
...
* [字典树](#字典树)
    ...
    * [4. 数组中两个数的最大异或值](#4-数组中两个数的最大异或值)
    * [5. Trie单词频率](#5-Trie单词频率)
    * [6. Trie多次搜索](#6-Trie次搜索)
...
* [多叉树](#多叉树)
    * [1. N叉树的前后序遍历](#1-N叉树的前后序遍历)
    * [2. N叉树的层序遍历](#2-N叉树的层序遍历)  
    * [3. 字典序的第K小数字](#3-字典序的第K小数字)
    * [4. 字典序排数](#4-字典序排数)
    * [5. N叉树的最大深度](#5-N叉树的最大深度)
...
[力扣](https://leetcode-cn.com/problems/er-cha-sou-suo-shu-de-di-kda-jie-dian-lcof/) / [Python3](../python-algorithm/ds_5_tree/tree_3_bst_property/LJ54.py)  
...
[力扣](https://leetcode-cn.com/problems/serialize-and-deserialize-bst/) / [Leetcode](https://leetcode.com/problems/serialize-and-deserialize-bst/) / [Cpp](../ds_5_tree/tree_4_build_tree/L449-m.cpp) / [Python3](../python-algorithm/ds_5_tree/tree_4_build_tree/L449-m.py)
...
# 树的遍历
## 1 二叉树的前中后序遍历
144\. Binary Tree Preorder Traversal   [力扣](https://leetcode-cn.com/problems/binary-tree-preorder-traversal/)      
94\. Binary Tree Inorder Traversal     [力扣](https://leetcode-cn.com/problems/binary-tree-inorder-traversal/)      
145\. Binary Tree Postorder Traversal  [力扣](https://leetcode-cn.com/problems/binary-tree-postorder-traversal/)      

[144](../python-algorithm/ds_5_tree/tree_2_traversal/L144-m.py) / [94](../python-algorithm/ds_5_tree/tree_2_traversal/L145-h.py) / [145](../python-algorithm/ds_5_tree/tree_2_traversal/L94-m.py)
...
[力扣](https://leetcode-cn.com/problems/all-nodes-distance-k-in-binary-tree/) / [Leetcode](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree/) / [Cpp](../ds_5_tree/tree_2_traversal/L863-m.cpp) / [Python3](../python-algorithm/ds_5_tree/tree_2_traversal/L863-m.py)
```
...
## 8 二叉树的下一个中序遍历节点
000\. [二叉树的下一个中序遍历节点](https://www.nowcoder.com/questionTerminal/9023a0c988684a53960365b889ceaf5e)  

[codetop](https://mp.weixin.qq.com/s?__biz=MzkxNDI1MTA1MA==&mid=2247484416&idx=1&sn=027876aa5ada092d1647e7cbe888708f&source=41#wechat_redirect) / [Python3](../python-algorithm/ds_5_tree/tree_2_traversal/b000-m.py)
```
题目:给定二叉树其中的一个结点（不一定是根节点），请找出其中序遍历顺序的下一个结点并且返回。
注意，树中的结点不仅包含左右子结点，而且包含指向父结点的指针。
```
```
题解：节点(设为x)中序遍历的下一个节点有以下可能：
      若x有右子树。则x的下一个节点为x右子树最左侧节点。如，2的下一个节点为8。
      若x没有右子树，又分为2种情况。
      若x是父节点的左孩子。则x的父节点就是x的下一个节点。如，7的下一个节点是4。
      若x是父节点的右孩子。则沿着父节点向上，直到找到一个节点的父节点的左孩子是该节点，
      则该节点的父节点就是x的下一个节点。如，9的下一个节点是1。
```

## 9 层数最深叶子节点的和
1302\. Deepest Leaves Sum

[力扣](https://leetcode-cn.com/problems/deepest-leaves-sum/) / [Leetcode](https://leetcode.com/problems/deepest-leaves-sum/) / [Cpp](../ds_5_tree/tree_2_traversal/L513-m.cpp) / [Python3](../python-algorithm/ds_5_tree/tree_2_traversal/L513-m.py)
```
题目:这道题用层序遍历较为直观；也需要注意用DFS的方法，对于其它题有借鉴意义。
```
...
[力扣](https://leetcode-cn.com/problems/maximum-xor-of-two-numbers-in-an-array/) / [Leetcode](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array/) / [Cpp](../ds_5_tree/tree_6_trie_tree/L421-m.cpp) / [Python3](../python-algorithm/ds_5_tree/tree_6_trie_tree/L421-m.py)
```
...
[力扣](https://leetcode-cn.com/problems/maximum-width-of-binary-tree/) / [Leetcode](https://leetcode.com/problems/maximum-width-of-binary-tree/) /  [Cpp](../ds_5_tree/tree_4_build_tree/L662-m.cpp) / [Python3](../python-algorithm/ds_5_tree/tree_4_build_tree/L662-m.py)
```
...
# 多叉树  
## 1 N叉树的前后序遍历
589\. N-ary Tree Preorder Traversal   [力扣](https://leetcode-cn.com/problems/n-ary-tree-preorder-traversal/)   
590\. N-ary Tree Postorder Traversal  [力扣](https://leetcode-cn.com/problems/n-ary-tree-postorder-traversal/)  

[589](../python-algorithm/ds_5_tree/tree_2_traversal/L589.py) / [590](../python-algorithm/ds_5_tree/tree_2_traversal/L590.py)
