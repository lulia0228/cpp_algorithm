...
* [递归-路径问题](#路径问题)
    ...
    * [3. 路径总和II](#3-路径总和II)    
    * [4. 二叉树的直径](#4-二叉树的直径)
    * [5. 求根到叶子节点数字之和](#5-求根到叶子节点数字之和)  
    * [6. 二叉树的所有路径](#6-二叉树的所有路径)
    * [7. 路径总和III](#7-路径总和III)
...
[力扣](https://leetcode-cn.com/problems/count-complete-tree-nodes/) / [Python3](../python-algorithm/ds_5_tree/tree_7_other_tree/L222-m.py)      
```
给你一棵 完全二叉树 的根节点 root ，求出该树的节点个数。
完全二叉树 的定义如下：在完全二叉树中，除了最底层节点可能没填满外，其余每层节点数都达到最大值，
