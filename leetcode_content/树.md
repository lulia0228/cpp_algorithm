...
* [树的构建](#树的构建)
    ...
    * [5. 合并二叉树](#5-合并二叉树)
    * [6. 判断二叉搜索树的后序遍历序列](#6-判断二叉搜索树的后序遍历序列)
    * [7. 根据前序和后序遍历构造二叉树](#7-根据前序和后序遍历构造二叉树)
    * [8. 序列化和反序列化二叉搜索树](#8-序列化和反序列化二叉搜索树)
    * [9. 最大二叉树](#9-最大二叉树)
    * [10. 不同的二叉搜索树II](#10-不同的二叉搜索树II)
