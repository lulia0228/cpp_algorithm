...
* [15. 翻转对](#15-翻转对)     493
* [16. 根据字符出现频率排序](#16-根据字符出现频率排序)    451. 
* [17. 根据数字二进制下1的数目排序](#17-根据数字二进制下1的数目排序)   1356
* [18. 最短无序连续子数组](#18-最短无序连续子数组)    581. 
* [19. 最小差](#19-最小差)    面试题 16.06. 最小差 
* [20. 拼接字符串](#20-拼接字符串)
...
[codetop](https://mp.weixin.qq.com/s?__biz=MzkxNDI1MTA1MA==&mid=2247484410&idx=1&sn=70abca1a04aef459531dd5b64e429aee&source=41#wechat_redirect) / [Python3](./python-algorithm/sword_point_offer/b计算数组的小和.py) 
```
