...
* [子序列问题](#子序列问题)
    ...
    * [9. 牛牛的数列](#9-牛牛的数列)
    * [10. 最长回文子序列](#10-最长回文子序列)
    * [11. 信封嵌套问题](#11-信封嵌套问题)
    * [12. 最长的括号子串](#12-最长的括号子串)
...
[牛客](https://www.nowcoder.com/practice/c7fc893654b44324b6763dea095ceaaf?tpId=117&&tqId=37864&rp=1&ru=/ta/job-code-high&qru=/ta/job-code-high/question-ranking) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_2_subsequence/NC154.py)   
```
...
[牛客](https://www.nowcoder.com/practice/9bf77b5b018d4d24951c9a7edb40408f?tpId=117&&tqId=37863&rp=1&ru=/ta/job-code-high&qru=/ta/job-code-high/question-ranking) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_2_subsequence/NC153.py)   
```
...
[牛客](https://www.nowcoder.com/practice/45fd68024a4c4e97a8d6c45fc61dc6ad?tpId=117&&tqId=37745&rp=1&ru=/ta/job-code-high&qru=/ta/job-code-high/question-ranking) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_2_subsequence/NC49.py)   
```
...
[牛客](https://leetcode-cn.com/problems/house-robber/description/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_5_rob/NC144.py) 
```
题目:一个长度为n的数组，在不同时选位置相邻的两个数，求该序列的最大子序列和（挑选出的子序列可以为空）。
```
...
[力扣](https://leetcode-cn.com/problems/one-away-lcci/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_4_special_state_transition/01.05.py) 
```
...
[力扣](https://leetcode-cn.com/problems/coin-lcci/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_4_special_state_transition/08.11.py) 
```
...
[力扣](https://leetcode-cn.com/problems/circus-tower-lcci/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_4_special_state_transition/17.08.py) 
```
...
[力扣](https://leetcode-cn.com/problems/get-kth-magic-number-lcci/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_4_special_state_transition/17.09.py) 
```
...
[力扣](https://leetcode-cn.com/problems/re-space-lcci/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_4_special_state_transition/17.13.py) 
```
...
[力扣](https://leetcode-cn.com/problems/longest-word-lcci/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_4_special_state_transition/17.15.py) 
```
...
[力扣](https://leetcode-cn.com/problems/max-black-square-lcci/) / [Python3](../python-algorithm/algo_05_dynamic_plan/dp_4_special_state_transition/17.23.py) 
```
