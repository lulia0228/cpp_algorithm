...
* [其它](#其它)
    ...
    * [4. 分发饼干](#4-分发饼干) 
    * [5. 分发糖果](#5-分发糖果)  
    * [6. 最短无序连续子数组](#6-最短无序连续子数组)  
    * [7. 非递减数列](#7-非递减数列)   
    * [8. 划分字母区间](#8-划分字母区间)  
    * [9. 有效的括号字符串](#9-有效的括号字符串) 
    * [10. 最大交换](#10-最大交换)   
    * [11. 将每个元素替换为右侧最大元素](#11-将每个元素替换为右侧最大元素)  
    * [12. 不含AAA或BBB的字符串](#12-不含AAA或BBB的字符串)  
    * [13. 灯泡开关III](#13-灯泡开关III)  
    * [14. 根据身高重建队列](#14-根据身高重建队列)  
    * [15. Can Place Flowers](#15-CanPlaceFlowers) 
    * [16. 扑克牌中的顺子](#16-扑克牌中的顺子)  
