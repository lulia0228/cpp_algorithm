...
* [4. 最长和谐序列](#4-最长和谐序列)
* [5. 最长连续序列](#5-最长连续序列)
* [6. 度相同的最短连续序列](#6-度相同的最短连续子数组)
* [7. Fizz Buzz](#7-FizzBuzz)
* [8. 外观数列](#8-外观数列)
* [9. 字母异位词分组](#9-字母异位词分组)
* [10. 有效的字母异位词](#10-有效的字母异位词)
* [11. 存在重复元素I](#11-存在重复元素I)
* [12. 存在重复元素II](#12-存在重复元素II)
* [13. 存在重复元素III](#13-存在重复元素III)
* [14. 两个数组的交集I](#14-两个数组的交集I)
* [15. 两个数组的交集II](#15-两个数组的交集II)
...
## 5 最长连续序列
128\. Longest Consecutive Sequence    NC95\. 数组中的最长连续子序列   
