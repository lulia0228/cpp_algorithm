...
* [2. 根据快排思想找数组第K大元素](#2-根据快排思想找数组第K大元素)
* [3. 数据流的中位数](#3-数据流的中位数)
* [4. 前K个高频元素](#4-前K个高频元素)
* [5. 前K个高频单词](#5-前K个高频单词)
* [6. 最小的k个数 ](#6-最小的k个数 )  
...
[牛客](https://www.nowcoder.com/practice/e016ad9b7f0b45048c58a9f27ba618bf?tpId=117&&tqId=37791&rp=1&ru=/activity/oj&qru=/ta/job-code-high/question-ranking) / [Python3](../python-algorithm/ds_2_heap/NC88.py)
```
